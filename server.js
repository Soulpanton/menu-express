...
desserts:[
	...
	{name:"chocolate cake snake", price:10},
...
app.get("/", (req, res) => {
    res.json({
        "message": "Well maybe not today triple og "
    })
})
...
app.listen(port, () => console.log(`Listening for pokemon api on ort ${port}`))
